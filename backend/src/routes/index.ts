...
createCrudRoutes('boq', boqService, 'BOQ');
createCrudRoutes('estimations', estimationService, 'Estimation');
createCrudRoutes('inspections', inspectionService, 'Inspection', undefined, true);
createCrudRoutes('daily-progress', dailyProgressService, 'DailyProgress');
createCrudRoutes('reports', reportService, 'Report');
createCrudRoutes('notes', noteService, 'Note', undefined, true);
createCrudRoutes('files', projectFileService, 'ProjectFile');
