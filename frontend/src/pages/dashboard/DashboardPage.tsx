      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                {(stats?.favoriteTools || ['Concrete Mix Design', 'Steel Weight Calculator', 'Slab Design', 'Unit Converter']).map((tool: any) => (
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                {(stats?.latestISCodes?.length ? stats.latestISCodes : [{ code: 'IS 456:2000', title: 'Plain Concrete' }, { code: 'IS 800:2007', title: 'Steel Design' }, { code: 'IS 875', title: 'Load Standards' }]).map((code: any) => (
              ...
              <div className="flex items-center gap-3">
                <div className="flex-1">
                  ...
                  <div className="mt-2 h-2 rounded-full bg-[hsl(var(--secondary))]">
                    <div className="h-full w-3/4 rounded-full bg-[hsl(221.2,83.2%,53.3%)]" />
                  </div>
                </div>
